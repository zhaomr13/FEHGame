...
func perform_melee_attack_sequence(target: BattleUnit, damage: int):
	...
	jump_tween.tween_property(battle_unit, "global_position", jump_target_global, 0.3)
	...
	return_tween.tween_property(battle_unit, "global_position", original_global_pos, 0.3)
